...
class ViewAllTravelsScreen extends StatefulWidget {
  const ViewAllTravelsScreen({Key? key}) : super(key: key);
  
  @override
  State<StatefulWidget> createState()=>_ViewAllTravelsScreenState();
}
class _ViewAllTravelsScreenState extends State<ViewAllTravelsScreen>{
  @override
